...
def home():
    ...
    <html>
        <head>
            <title>Flask App - Jean Mora</title>
            <style>
        ...
        <body>
            <div class="container">
                ...
                <hr>
                <p><a href="/saludo/Jean">👉 Haz clic aquí para probar la ruta de saludo</a></p>
            </div>
        </body>
    </html>
    """
...
def saludo(nombre):
    ...
    <html>
        ...
        <body>
            <div class="container">
                <h2>👋 Hola {nombre}!</h2>
                <p>Bienvenido a <strong>jeanmora.byronrm.com</strong></p>
...
@app.route('/health')
def health():
    return {"status": "healthy", "service": "jeanmora-flask-app", "version": "4.0"}
